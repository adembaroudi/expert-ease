...
//--/ this function is about company add job Ahmed//
                    ...
                    <div class="doctor-widget">
                        ...
                        <div class="doc-info-right">
                            ...
                            <div class="clinic-booking">
                                ...
                                <a class="apt-btn" type="button"  onclick="qualifJob()">send request</a>
                            </div>
                        </div>
                    </div>
                </div>
...
function editJob(id) {
    ...
    var w = document.getElementById("editform");
...
function load() {
    let y = document.getElementById("editform");
...
//--/ this function is about search//
//-->this function is about select specialities//
function searchspec() {
...
// this function is about accepting expert applied//

// this function is about accepting expert applied//

// this function is about rejecting expert applied//
function refus(id) {
...
function afficheJob() {
    ...
    let html = `<div class="text-right">
                        <input href="http://127.0.0.1:5500/Expert%20Add%20Job%20Offer.html" type="button"
                            class="add-new-btn">Post job offer</input>
                    </div>
                    <div class="card card-table mb-0">
                        <div class="card-body">
                            <div class="table-responsive">
...
//this function is about expert posting job//
function publication() {
    let jobOffers = JSON.parse(localStorage.getItem('job offer expert')) || [];
    let html = `<div id="myDiv">`
    document.getElementByc
    for (let i = 0; i < jobOffers.length; i++) {
        // if((jobOffers[i].owner==expertcn)&&(jobOffers[i].status!=="rejected")){
        html += `<div class="col-md-12 col-lg-8 col-xl-9">
                                              ...
                                              <div class="card-body">
                                                  <div class="doctor-widget">
                                                      ...
                                                      <div class="doc-info-right">
                                                          ...
                                                          <div class="clinic-booking">
                                                              <a class="view-pro-btn" href="expert-profile.html">View Profile</a>
                                                              <a class="apt-btn" type="button" onclick="sendJob()">send request</a>
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
...
// this function is about display job request from companys//
function affRequest() {
...
// this function is about rejecting job request // 
function reject(id) {
    console.log(id);
...
// this function is about accepting job request // 
function accept(id) {
    console.log(id);
...
// this function is about loading accpet/reject buttons//
function AcRe() {
...
//this function is about loading specialities in home page//
function spechome() {
